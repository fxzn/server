...
import { checkPayment, paymentNotification, searchDestinations } from '../controller/checkout-controller.js';
...
router.get('/orders/:orderId/payment-status', checkPayment);
